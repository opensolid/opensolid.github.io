...
var _opensolid$guides$Common$colorString = function (color) {
	var _p0 = color;
	switch (_p0.ctor) {
		case 'Black':
			return 'black';
		case 'Blue':
			return 'rgb(0, 109, 219)';
		case 'Orange':
			return 'rgb(219, 109, 0)';
		default:
			return 'rgb(0, 146, 146)';
	}
};
var _opensolid$guides$Common$config = {
	scale: 100.0,
	stroke: {width: 2.0e-2, thinWidth: 1.0e-2},
	point: {radius: 5.0e-2},
	originPoint: {radius: 5.0e-2},
	centerPoint: {radius: 3.0e-2, crossRadius: 0.1},
	direction: {length: 1, tipLength: 0.15, tipWidth: 0.1}
};
var _opensolid$guides$Common$pixelsPerUnit = _opensolid$guides$Common$config.scale;
var _opensolid$guides$Common$scene2d = F2(
	function (boundingBox, elements) {
		var globalAttributes = {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$strokeWidth(
				_elm_lang$core$Basics$toString(_opensolid$guides$Common$config.stroke.width)),
			_1: {ctor: '[]'}
		};
		var maxY = _opensolid$geometry$OpenSolid_BoundingBox2d$maxY(boundingBox);
		var minY = _opensolid$geometry$OpenSolid_BoundingBox2d$minY(boundingBox);
		var height = _elm_lang$core$Basics$toString(_opensolid$guides$Common$config.scale * (maxY - minY));
		var maxX = _opensolid$geometry$OpenSolid_BoundingBox2d$maxX(boundingBox);
		var minX = _opensolid$geometry$OpenSolid_BoundingBox2d$minX(boundingBox);
		var width = _elm_lang$core$Basics$toString(_opensolid$guides$Common$config.scale * (maxX - minX));
		var topLeftFrame = _opensolid$geometry$OpenSolid_Geometry_Types$Frame2d(
			{
				...
				xDirection: _opensolid$geometry$OpenSolid_Direction2d$x,
				yDirection: _opensolid$geometry$OpenSolid_Direction2d$flip(_opensolid$geometry$OpenSolid_Direction2d$y)
			});
		return A2(
			...
			},
			{
				...
				_0: A3(
					...
					_opensolid$guides$Common$config.scale,
					A2(
						_opensolid$svg$OpenSolid_Svg$relativeTo,
						topLeftFrame,
						A2(_elm_lang$svg$Svg$g, globalAttributes, elements))),
				_1: {ctor: '[]'}
			});
	});
var _opensolid$guides$Common$point2d = F2(
		...
		return A2(
			_opensolid$svg$OpenSolid_Svg$circle2d,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$fill(
					_opensolid$guides$Common$colorString(color)),
				_1: {ctor: '[]'}
			},
			_opensolid$geometry$OpenSolid_Geometry_Types$Circle2d(
				{centerPoint: point, radius: _opensolid$guides$Common$config.point.radius}));
	});
var _opensolid$guides$Common$centerPoint2d = F2(
	function (color, point) {
		var circle = _opensolid$geometry$OpenSolid_Geometry_Types$Circle2d(
			{centerPoint: _opensolid$geometry$OpenSolid_Point2d$origin, radius: _opensolid$guides$Common$config.centerPoint.radius});
		var verticalLine = _opensolid$geometry$OpenSolid_Geometry_Types$LineSegment2d(
			{
				ctor: '_Tuple2',
				_0: _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
					{ctor: '_Tuple2', _0: 0, _1: 0 - _opensolid$guides$Common$config.centerPoint.crossRadius}),
				_1: _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
					{ctor: '_Tuple2', _0: 0, _1: _opensolid$guides$Common$config.centerPoint.crossRadius})
			});
		var horizontalLine = _opensolid$geometry$OpenSolid_Geometry_Types$LineSegment2d(
			{
				ctor: '_Tuple2',
				_0: _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
					{ctor: '_Tuple2', _0: 0 - _opensolid$guides$Common$config.centerPoint.crossRadius, _1: 0}),
				_1: _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
					{ctor: '_Tuple2', _0: _opensolid$guides$Common$config.centerPoint.crossRadius, _1: 0})
			});
		return A2(
			_opensolid$svg$OpenSolid_Svg$placeIn,
			_opensolid$geometry$OpenSolid_Frame2d$at(point),
			A2(
				_elm_lang$svg$Svg$g,
				{ctor: '[]'},
				{
						...
						_0: A2(
							_elm_lang$svg$Svg$g,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$strokeWidth(
										_elm_lang$core$Basics$toString(_opensolid$guides$Common$config.stroke.thinWidth)),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _opensolid$guides$Common$originPoint2d = F2(
	function (color, point) {
		var circle = _opensolid$geometry$OpenSolid_Geometry_Types$Circle2d(
			{centerPoint: point, radius: _opensolid$guides$Common$config.originPoint.radius});
		var attributes = {
			ctor: '::',
		...
		return A2(_opensolid$svg$OpenSolid_Svg$circle2d, attributes, circle);
	});
var _opensolid$guides$Common$direction2d = F3(
	function (color, basePoint, direction) {
		var attributes = {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$stroke(
				_opensolid$guides$Common$colorString(color)),
		...
		var stemLength = _opensolid$guides$Common$config.direction.length - _opensolid$guides$Common$config.direction.tipLength;
		var stemPoint = _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
			{ctor: '_Tuple2', _0: stemLength, _1: 0});
		var stem = _opensolid$geometry$OpenSolid_Geometry_Types$LineSegment2d(
			{ctor: '_Tuple2', _0: _opensolid$geometry$OpenSolid_Point2d$origin, _1: stemPoint});
		var leftPoint = _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
			{ctor: '_Tuple2', _0: stemLength, _1: _opensolid$guides$Common$config.direction.tipWidth / 2});
		var rightPoint = _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
			{ctor: '_Tuple2', _0: stemLength, _1: (0 - _opensolid$guides$Common$config.direction.tipWidth) / 2});
		var tipPoint = _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
			{ctor: '_Tuple2', _0: _opensolid$guides$Common$config.direction.length, _1: 0});
		var tip = _opensolid$geometry$OpenSolid_Geometry_Types$Triangle2d(
			{ctor: '_Tuple3', _0: tipPoint, _1: leftPoint, _2: rightPoint});
		var frame = _opensolid$geometry$OpenSolid_Geometry_Types$Frame2d(
			{
				originPoint: basePoint,
				xDirection: direction,
				yDirection: _opensolid$geometry$OpenSolid_Direction2d$perpendicularTo(direction)
			});
		return A2(
			_opensolid$svg$OpenSolid_Svg$placeIn,
			frame,
...
var _opensolid$guides$Common$frame2d = F2(
	function (color, frame) {
		var yDirection = _opensolid$geometry$OpenSolid_Frame2d$yDirection(frame);
		var xDirection = _opensolid$geometry$OpenSolid_Frame2d$xDirection(frame);
		var originPoint = _opensolid$geometry$OpenSolid_Frame2d$originPoint(frame);
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A3(_opensolid$guides$Common$direction2d, color, originPoint, xDirection),
				_1: {
					ctor: '::',
					_0: A3(_opensolid$guides$Common$direction2d, color, originPoint, yDirection),
					_1: {
						ctor: '::',
						_0: A2(_opensolid$guides$Common$originPoint2d, color, originPoint),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _opensolid$guides$Common$lineSegment2d = F2(
	function (color, lineSegment) {
		var lineSegmentAttributes = {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$stroke(
				_opensolid$guides$Common$colorString(color)),
			_1: {
		...
		var _p1 = _opensolid$geometry$OpenSolid_LineSegment2d$endpoints(lineSegment);
		var p1 = _p1._0;
		var p2 = _p1._1;
		return A2(
			_elm_lang$svg$Svg$g,
			...
			{
				ctor: '::',
				_0: A2(_opensolid$svg$OpenSolid_Svg$lineSegment2d, lineSegmentAttributes, lineSegment),
				_1: {
					ctor: '::',
					_0: A2(_opensolid$guides$Common$point2d, color, p1),
					_1: {
						ctor: '::',
						_0: A2(_opensolid$guides$Common$point2d, color, p2),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _opensolid$guides$Common$triangle2d = F2(
	function (color, triangle) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_opensolid$svg$OpenSolid_Svg$triangle2d, triangleAttributes, triangle),
				_1: {
					ctor: '::',
					_0: A2(_opensolid$guides$Common$point2d, color, p1),
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_opensolid$guides$Common$point2d, color, p3),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _opensolid$guides$Common$Teal = {ctor: 'Teal'};
var _opensolid$guides$Common$Orange = {ctor: 'Orange'};
var _opensolid$guides$Common$Blue = {ctor: 'Blue'};
var _opensolid$guides$Common$Black = {ctor: 'Black'};

var _opensolid$guides$Frames_Common$yTip = function (frame) {
	return A2(
...
var _opensolid$guides$Frames_Common$xTip = function (frame) {
	return A2(
		_opensolid$geometry$OpenSolid_Point2d$placeIn,
		frame,
		_opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
...
var _opensolid$guides$Frames_Common$sweptAngleAround = F3(
	function (centerPoint, startPoint, endPoint) {
		var endDirection = _opensolid$geometry$OpenSolid_Vector2d$direction(
			A2(_opensolid$geometry$OpenSolid_Point2d$vectorFrom, centerPoint, endPoint));
		var startDirection = _opensolid$geometry$OpenSolid_Vector2d$direction(
			A2(_opensolid$geometry$OpenSolid_Point2d$vectorFrom, centerPoint, startPoint));
		return A3(_elm_lang$core$Maybe$map2, _opensolid$geometry$OpenSolid_Direction2d$angleFrom, startDirection, endDirection);
	});
var _opensolid$guides$Frames_Common$dragDisplacement = F2(
	function (dragStart, dragEnd) {
		return _opensolid$geometry$OpenSolid_Geometry_Types$Vector2d(
			{
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toFloat(dragEnd.x - dragStart.x) / _opensolid$guides$Common$pixelsPerUnit,
				_1: _elm_lang$core$Basics$toFloat(dragStart.y - dragEnd.y) / _opensolid$guides$Common$pixelsPerUnit
			});
	});
var _opensolid$guides$Frames_Common$onMouseDown = function (tag) {
	return A2(
		_elm_lang$svg$Svg_Events$on,
		'mousedown',
		A2(_elm_lang$core$Json_Decode$map, tag, _elm_lang$mouse$Mouse$position));
};
var _opensolid$guides$Frames_Common$dragCircle = F2(
	function (tag, point) {
		...
		return A2(
			_elm_lang$svg$Svg$circle,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$r('0.15'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$stroke('none'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill('rgba(0, 0, 0, 0)'),
								_1: {
									ctor: '::',
									_0: _opensolid$guides$Frames_Common$onMouseDown(tag),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _opensolid$guides$Frames_Common$noSelectAttribute = _elm_lang$svg$Svg_Attributes$style(
	A2(
		_elm_lang$core$String$join,
		'; ',
		{
			ctor: '::',
			_0: '-webkit-user-select: none',
			_1: {
				ctor: '::',
				_0: '-moz-user-select: none',
				_1: {
					ctor: '::',
					_0: '-ms-user-select: none',
					_1: {
						ctor: '::',
						_0: 'user-select: none',
						_1: {ctor: '[]'}
...
var _opensolid$guides$Frames_Common$formatFloat = _krisajenkins$formatting$Formatting$print(
	_krisajenkins$formatting$Formatting$roundTo(2));
var _opensolid$guides$Frames_Common$coordinateLabel = F3(
	function (viewBox, color, point) {
		var mirrorAxis = _opensolid$geometry$OpenSolid_Geometry_Types$Axis2d(
			{originPoint: point, direction: _opensolid$geometry$OpenSolid_Direction2d$x});
		var offset = 0.1;
		var _p1 = _opensolid$geometry$OpenSolid_Point2d$coordinates(point);
		var x = _p1._0;
		var y = _p1._1;
		var _p2 = (_elm_lang$core$Native_Utils.cmp(
			x,
			_opensolid$geometry$OpenSolid_BoundingBox2d$midX(viewBox)) < 1) ? {ctor: '_Tuple2', _0: x + offset, _1: 'start'} : {ctor: '_Tuple2', _0: x - offset, _1: 'end'};
		var anchorX = _p2._0;
		var anchorType = _p2._1;
		var coordinatesString = A2(
			_elm_lang$core$Basics_ops['++'],
			'(',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_opensolid$guides$Frames_Common$formatFloat(x),
				A2(
					_elm_lang$core$Basics_ops['++'],
					', ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_opensolid$guides$Frames_Common$formatFloat(y),
						')'))));
		return A2(
			...
			A2(
				_elm_lang$svg$Svg$text_,
				{
					...
					_0: _elm_lang$svg$Svg_Attributes$x(
						_elm_lang$core$Basics$toString(anchorX)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$textAnchor(anchorType),
						_1: {
							ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fontSize('0.15'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill(
										_opensolid$guides$Common$colorString(color)),
									_1: {
										ctor: '::',
										_0: _opensolid$guides$Frames_Common$noSelectAttribute,
										_1: {ctor: '[]'}
									}
								}
							}
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg$text(coordinatesString),
					_1: {ctor: '[]'}
				}));
	});
var _opensolid$guides$Frames_Common$coordinateLines = F3(
	function (point, referenceAxis, color) {
		var projectedPoint = A2(_opensolid$geometry$OpenSolid_Point2d$projectOnto, referenceAxis, point);
		var perpendicularSegment = _opensolid$geometry$OpenSolid_Geometry_Types$LineSegment2d(
			{ctor: '_Tuple2', _0: projectedPoint, _1: point});
		var axisOrigin = _opensolid$geometry$OpenSolid_Axis2d$originPoint(referenceAxis);
		var parallelSegment = _opensolid$geometry$OpenSolid_Geometry_Types$LineSegment2d(
			{ctor: '_Tuple2', _0: axisOrigin, _1: projectedPoint});
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$strokeDasharray('0.03 0.03'),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _opensolid$guides$Frames_PlaceIn$rotatedFrame = F3(
	function (frame, tipPoint, tipDisplacement) {
		var rotationAngle = A3(
			_opensolid$guides$Frames_Common$sweptAngleAround,
			_opensolid$geometry$OpenSolid_Frame2d$originPoint(frame),
			tipPoint,
			A2(_opensolid$geometry$OpenSolid_Point2d$translateBy, tipDisplacement, tipPoint));
		var _p0 = rotationAngle;
		if (_p0.ctor === 'Just') {
			return A2(_opensolid$geometry$OpenSolid_Frame2d$rotateBy, _p0._0, frame);
		} else {
			return frame;
		}
	});
var _opensolid$guides$Frames_PlaceIn$transformedFrame = function (model) {
	var _p1 = model.dragInProgress;
	if (_p1.ctor === 'Just') {
		var displacement = A2(_opensolid$guides$Frames_Common$dragDisplacement, _p1._0._1, _p1._0._2);
		var _p2 = _p1._0._0;
		switch (_p2.ctor) {
			case 'OriginPoint':
				return A2(_opensolid$geometry$OpenSolid_Frame2d$translateBy, displacement, model.frame);
			case 'XDirection':
				return A3(
					_opensolid$guides$Frames_PlaceIn$rotatedFrame,
					model.frame,
					_opensolid$guides$Frames_Common$xTip(model.frame),
					displacement);
			case 'YDirection':
				return A3(
					_opensolid$guides$Frames_PlaceIn$rotatedFrame,
					model.frame,
					_opensolid$guides$Frames_Common$yTip(model.frame),
					displacement);
			default:
				return model.frame;
		}
...
var _opensolid$guides$Frames_PlaceIn$transformedPoint = function (model) {
	var _p3 = model.dragInProgress;
	if (((_p3.ctor === 'Just') && (_p3._0.ctor === '_Tuple3')) && (_p3._0._0.ctor === 'Point')) {
		return A2(
			_opensolid$geometry$OpenSolid_Point2d$translateBy,
			A2(_opensolid$guides$Frames_Common$dragDisplacement, _p3._0._1, _p3._0._2),
			model.point);
	} else {
		return model.point;
	}
};
var _opensolid$guides$Frames_PlaceIn$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'DragStart':
				var _p5 = _p4._1;
				var newDrag = {ctor: '_Tuple3', _0: _p4._0, _1: _p5, _2: _p5};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							dragInProgress: _elm_lang$core$Maybe$Just(newDrag)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'DragTo':
				var _p6 = model.dragInProgress;
				if (_p6.ctor === 'Just') {
					var updatedDrag = {ctor: '_Tuple3', _0: _p6._0._0, _1: _p6._0._1, _2: _p4._0};
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								dragInProgress: _elm_lang$core$Maybe$Just(updatedDrag)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							point: _opensolid$guides$Frames_PlaceIn$transformedPoint(model),
							frame: _opensolid$guides$Frames_PlaceIn$transformedFrame(model),
							dragInProgress: _elm_lang$core$Maybe$Nothing
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _opensolid$guides$Frames_PlaceIn$init = function () {
	var initialFrame = A2(
		_opensolid$geometry$OpenSolid_Frame2d$rotateBy,
		_elm_lang$core$Basics$degrees(30),
		_opensolid$geometry$OpenSolid_Frame2d$at(
			_opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
				{ctor: '_Tuple2', _0: 0.75, _1: 0.75})));
	var initialPoint = _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
		{ctor: '_Tuple2', _0: 0.5, _1: 0.5});
	var initialModel = {point: initialPoint, frame: initialFrame, dragInProgress: _elm_lang$core$Maybe$Nothing};
	return {ctor: '_Tuple2', _0: initialModel, _1: _elm_lang$core$Platform_Cmd$none};
}();
var _opensolid$guides$Frames_PlaceIn$Model = F3(
	function (a, b, c) {
		return {point: a, frame: b, dragInProgress: c};
	});
var _opensolid$guides$Frames_PlaceIn$YDirection = {ctor: 'YDirection'};
var _opensolid$guides$Frames_PlaceIn$XDirection = {ctor: 'XDirection'};
var _opensolid$guides$Frames_PlaceIn$OriginPoint = {ctor: 'OriginPoint'};
var _opensolid$guides$Frames_PlaceIn$Point = {ctor: 'Point'};
var _opensolid$guides$Frames_PlaceIn$DragEnd = function (a) {
	return {ctor: 'DragEnd', _0: a};
};
var _opensolid$guides$Frames_PlaceIn$DragTo = function (a) {
	return {ctor: 'DragTo', _0: a};
};
var _opensolid$guides$Frames_PlaceIn$subscriptions = function (model) {
	var _p7 = model.dragInProgress;
	if (_p7.ctor === 'Nothing') {
		return _elm_lang$core$Platform_Sub$none;
	} else {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_opensolid$guides$Frames_PlaceIn$DragTo),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_opensolid$guides$Frames_PlaceIn$DragEnd),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _opensolid$guides$Frames_PlaceIn$DragStart = F2(
	function (a, b) {
		return {ctor: 'DragStart', _0: a, _1: b};
	});
var _opensolid$guides$Frames_PlaceIn$view = function (model) {
	var currentFrame = _opensolid$guides$Frames_PlaceIn$transformedFrame(model);
	var originPoint = _opensolid$geometry$OpenSolid_Frame2d$originPoint(currentFrame);
	var xTipPoint = _opensolid$guides$Frames_Common$xTip(currentFrame);
	var yTipPoint = _opensolid$guides$Frames_Common$yTip(currentFrame);
	var xAxis = _opensolid$geometry$OpenSolid_Frame2d$xAxis(currentFrame);
	var currentPoint = _opensolid$guides$Frames_PlaceIn$transformedPoint(model);
	var placedPoint = A2(_opensolid$geometry$OpenSolid_Point2d$placeIn, currentFrame, currentPoint);
	var viewBox = _opensolid$geometry$OpenSolid_Geometry_Types$BoundingBox2d(
		{minX: -0.5, minY: -1, maxX: 2.5, maxY: 2.5});
	return A2(
		...
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
				_opensolid$guides$Common$scene2d,
				viewBox,
				{
					ctor: '::',
					_0: A3(_opensolid$guides$Frames_Common$coordinateLines, currentPoint, _opensolid$geometry$OpenSolid_Axis2d$x, _opensolid$guides$Common$Blue),
					_1: {
						ctor: '::',
						_0: A2(_opensolid$guides$Common$frame2d, _opensolid$guides$Common$Blue, _opensolid$geometry$OpenSolid_Frame2d$xy),
						_1: {
							ctor: '::',
							_0: A2(_opensolid$guides$Common$point2d, _opensolid$guides$Common$Orange, currentPoint),
							_1: {
								ctor: '::',
								_0: A3(_opensolid$guides$Frames_Common$coordinateLabel, viewBox, _opensolid$guides$Common$Blue, currentPoint),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$svg$Svg$g,
										{
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$cursor('move'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												_opensolid$guides$Frames_Common$dragCircle,
												_opensolid$guides$Frames_PlaceIn$DragStart(_opensolid$guides$Frames_PlaceIn$Point),
												currentPoint),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_opensolid$guides$Frames_Common$coordinateLines, placedPoint, xAxis, _opensolid$guides$Common$Blue),
						_1: {
							ctor: '::',
							_0: A3(_opensolid$guides$Frames_Common$coordinateLines, placedPoint, _opensolid$geometry$OpenSolid_Axis2d$x, _opensolid$guides$Common$Black),
							_1: {
								ctor: '::',
								_0: A2(_opensolid$guides$Common$frame2d, _opensolid$guides$Common$Black, _opensolid$geometry$OpenSolid_Frame2d$xy),
								_1: {
									ctor: '::',
									_0: A2(_opensolid$guides$Common$frame2d, _opensolid$guides$Common$Blue, currentFrame),
									_1: {
										ctor: '::',
										_0: A2(_opensolid$guides$Common$point2d, _opensolid$guides$Common$Orange, placedPoint),
										_1: {
											ctor: '::',
											_0: A3(_opensolid$guides$Frames_Common$coordinateLabel, viewBox, _opensolid$guides$Common$Black, placedPoint),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$svg$Svg$g,
													...
													},
													{
														...
														_0: A2(
															_opensolid$guides$Frames_Common$dragCircle,
															_opensolid$guides$Frames_PlaceIn$DragStart(_opensolid$guides$Frames_PlaceIn$XDirection),
															xTipPoint),
														_1: {
															ctor: '::',
															_0: A2(
																_opensolid$guides$Frames_Common$dragCircle,
																_opensolid$guides$Frames_PlaceIn$DragStart(_opensolid$guides$Frames_PlaceIn$YDirection),
																yTipPoint),
															_1: {
																ctor: '::',
																_0: A2(
																	_opensolid$guides$Frames_Common$dragCircle,
																	_opensolid$guides$Frames_PlaceIn$DragStart(_opensolid$guides$Frames_PlaceIn$OriginPoint),
																	originPoint),
																_1: {ctor: '[]'}
															}
														}
...
var _opensolid$guides$Frames_PlaceIn$main = _elm_lang$html$Html$program(
	{init: _opensolid$guides$Frames_PlaceIn$init, view: _opensolid$guides$Frames_PlaceIn$view, update: _opensolid$guides$Frames_PlaceIn$update, subscriptions: _opensolid$guides$Frames_PlaceIn$subscriptions})();

var _opensolid$guides$Frames_RelativeTo$rotatedFrame = F3(
	function (frame, tipPoint, tipDisplacement) {
		var rotationAngle = A3(
			_opensolid$guides$Frames_Common$sweptAngleAround,
			_opensolid$geometry$OpenSolid_Frame2d$originPoint(frame),
...
var _opensolid$guides$Frames_RelativeTo$transformedFrame = function (model) {
	var _p1 = model.dragInProgress;
	if (_p1.ctor === 'Just') {
		var displacement = A2(_opensolid$guides$Frames_Common$dragDisplacement, _p1._0._1, _p1._0._2);
		var _p2 = _p1._0._0;
		switch (_p2.ctor) {
			...
			case 'XDirection':
				return A3(
					_opensolid$guides$Frames_RelativeTo$rotatedFrame,
					model.frame,
					_opensolid$guides$Frames_Common$xTip(model.frame),
					displacement);
			case 'YDirection':
...
var _opensolid$guides$Frames_RelativeTo$transformedPoint = function (model) {
	var _p3 = model.dragInProgress;
	if (((_p3.ctor === 'Just') && (_p3._0.ctor === '_Tuple3')) && (_p3._0._0.ctor === 'Point')) {
		return A2(
			_opensolid$geometry$OpenSolid_Point2d$translateBy,
...
var _opensolid$guides$Frames_RelativeTo$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'DragStart':
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							point: _opensolid$guides$Frames_RelativeTo$transformedPoint(model),
							frame: _opensolid$guides$Frames_RelativeTo$transformedFrame(model),
							dragInProgress: _elm_lang$core$Maybe$Nothing
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _opensolid$guides$Frames_RelativeTo$init = function () {
	var initialFrame = A2(
		_opensolid$geometry$OpenSolid_Frame2d$rotateBy,
		_elm_lang$core$Basics$degrees(30),
		_opensolid$geometry$OpenSolid_Frame2d$at(
			_opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
				{ctor: '_Tuple2', _0: 0.75, _1: 0.75})));
	var initialPoint = _opensolid$geometry$OpenSolid_Geometry_Types$Point2d(
		{ctor: '_Tuple2', _0: 1.5, _1: 0.5});
	var initialModel = {point: initialPoint, frame: initialFrame, dragInProgress: _elm_lang$core$Maybe$Nothing};
	return {ctor: '_Tuple2', _0: initialModel, _1: _elm_lang$core$Platform_Cmd$none};
}();
var _opensolid$guides$Frames_RelativeTo$Model = F3(
	function (a, b, c) {
		return {point: a, frame: b, dragInProgress: c};
	});
var _opensolid$guides$Frames_RelativeTo$YDirection = {ctor: 'YDirection'};
var _opensolid$guides$Frames_RelativeTo$XDirection = {ctor: 'XDirection'};
var _opensolid$guides$Frames_RelativeTo$OriginPoint = {ctor: 'OriginPoint'};
var _opensolid$guides$Frames_RelativeTo$Point = {ctor: 'Point'};
var _opensolid$guides$Frames_RelativeTo$DragEnd = function (a) {
	return {ctor: 'DragEnd', _0: a};
};
var _opensolid$guides$Frames_RelativeTo$DragTo = function (a) {
	return {ctor: 'DragTo', _0: a};
};
var _opensolid$guides$Frames_RelativeTo$subscriptions = function (model) {
	var _p7 = model.dragInProgress;
	if (_p7.ctor === 'Nothing') {
		return _elm_lang$core$Platform_Sub$none;
	} else {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_opensolid$guides$Frames_RelativeTo$DragTo),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_opensolid$guides$Frames_RelativeTo$DragEnd),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _opensolid$guides$Frames_RelativeTo$DragStart = F2(
	function (a, b) {
		return {ctor: 'DragStart', _0: a, _1: b};
	});
var _opensolid$guides$Frames_RelativeTo$view = function (model) {
	var currentFrame = _opensolid$guides$Frames_RelativeTo$transformedFrame(model);
	var originPoint = _opensolid$geometry$OpenSolid_Frame2d$originPoint(currentFrame);
	var xTipPoint = _opensolid$guides$Frames_Common$xTip(currentFrame);
	var yTipPoint = _opensolid$guides$Frames_Common$yTip(currentFrame);
	var xAxis = _opensolid$geometry$OpenSolid_Frame2d$xAxis(currentFrame);
	var currentPoint = _opensolid$guides$Frames_RelativeTo$transformedPoint(model);
	var relativePoint = A2(_opensolid$geometry$OpenSolid_Point2d$relativeTo, currentFrame, currentPoint);
	var viewBox = _opensolid$geometry$OpenSolid_Geometry_Types$BoundingBox2d(
		{minX: -0.5, minY: -1, maxX: 2.5, maxY: 2.5});
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A3(_opensolid$guides$Frames_Common$coordinateLines, currentPoint, xAxis, _opensolid$guides$Common$Blue),
					_1: {
						ctor: '::',
						_0: A3(_opensolid$guides$Frames_Common$coordinateLines, currentPoint, _opensolid$geometry$OpenSolid_Axis2d$x, _opensolid$guides$Common$Black),
						_1: {
							ctor: '::',
							_0: A2(_opensolid$guides$Common$frame2d, _opensolid$guides$Common$Black, _opensolid$geometry$OpenSolid_Frame2d$xy),
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A3(_opensolid$guides$Frames_Common$coordinateLabel, viewBox, _opensolid$guides$Common$Black, currentPoint),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$svg$Svg$g,
												...
												},
												{
													...
													_0: A2(
														_opensolid$guides$Frames_Common$dragCircle,
														_opensolid$guides$Frames_RelativeTo$DragStart(_opensolid$guides$Frames_RelativeTo$XDirection),
														xTipPoint),
													_1: {
														ctor: '::',
														_0: A2(
															_opensolid$guides$Frames_Common$dragCircle,
															_opensolid$guides$Frames_RelativeTo$DragStart(_opensolid$guides$Frames_RelativeTo$YDirection),
															yTipPoint),
														_1: {
															ctor: '::',
															_0: A2(
																_opensolid$guides$Frames_Common$dragCircle,
																_opensolid$guides$Frames_RelativeTo$DragStart(_opensolid$guides$Frames_RelativeTo$OriginPoint),
																originPoint),
															_1: {
																ctor: '::',
																_0: A2(
																	_opensolid$guides$Frames_Common$dragCircle,
																	_opensolid$guides$Frames_RelativeTo$DragStart(_opensolid$guides$Frames_RelativeTo$Point),
																	currentPoint),
																_1: {ctor: '[]'}
															}
														}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_opensolid$guides$Frames_Common$coordinateLines, relativePoint, _opensolid$geometry$OpenSolid_Axis2d$x, _opensolid$guides$Common$Blue),
						_1: {
							ctor: '::',
							_0: A2(_opensolid$guides$Common$frame2d, _opensolid$guides$Common$Blue, _opensolid$geometry$OpenSolid_Frame2d$xy),
							_1: {
								ctor: '::',
								_0: A2(_opensolid$guides$Common$point2d, _opensolid$guides$Common$Orange, relativePoint),
								_1: {
									ctor: '::',
									_0: A3(_opensolid$guides$Frames_Common$coordinateLabel, viewBox, _opensolid$guides$Common$Blue, relativePoint),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _opensolid$guides$Frames_RelativeTo$main = _elm_lang$html$Html$program(
	{init: _opensolid$guides$Frames_RelativeTo$init, view: _opensolid$guides$Frames_RelativeTo$view, update: _opensolid$guides$Frames_RelativeTo$update, subscriptions: _opensolid$guides$Frames_RelativeTo$subscriptions})();

var Elm = {};
Elm['Frames'] = Elm['Frames'] || {};
Elm['Frames']['PlaceIn'] = Elm['Frames']['PlaceIn'] || {};
if (typeof _opensolid$guides$Frames_PlaceIn$main !== 'undefined') {
    _opensolid$guides$Frames_PlaceIn$main(Elm['Frames']['PlaceIn'], 'Frames.PlaceIn', undefined);
}
Elm['Frames'] = Elm['Frames'] || {};
Elm['Frames']['RelativeTo'] = Elm['Frames']['RelativeTo'] || {};
if (typeof _opensolid$guides$Frames_RelativeTo$main !== 'undefined') {
    _opensolid$guides$Frames_RelativeTo$main(Elm['Frames']['RelativeTo'], 'Frames.RelativeTo', undefined);
}
